...
function ballMove(){
  ...
  if((ballLeft <=20 && ballLeft >= 0)){
    ...
    if (ballTop >= player1Top + 15 && ballTop <= player1Top + 20) { 
      ...
      p2HitStraight= false
      p1HitStraight = true; 
    }else if (ballTop < player1Top + 20 && ballTop > player1Top - 10 ) {
      p2hitDown = false 
      p2HitUp = false
      p2HitStraight= false
      p1HitUp = true;
  ...
  if(ballLeft >= 570 && ballLeft <= 600){
    let player2Top = parseFloat(getComputedStyle(player2).getPropertyValue('top'))
    if (ballTop >= player2Top + 15 && ballTop <= player2Top + 20) { 
      p1HitStraight = false
      p1hitDown = false
      p1HitUp = false
      p2HitStraight = true
    ...
    }else if (ballTop < player2Top -10 + 20 && ballTop > player2Top - 10) { 
      p1HitStraight = false
      p1hitDown = false
      p1HitUp = false
      p2HitUp = true;
    }else if (ballTop > player2Top + 20 && ballTop < player2Top + 50) { 
      p1HitStraight = false
      p1hitDown = false
      p1HitUp = false
      p2hitDown = true;   
